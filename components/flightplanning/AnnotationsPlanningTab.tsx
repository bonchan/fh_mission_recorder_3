...
export function AnnotationsPlanningTab({ orgId, projectId, sourceTabId, debugMode, onSelectionChange, homePoint, onHomePointChange, isActive, viewRef }: AnnotationsPlanningTabProps) {
