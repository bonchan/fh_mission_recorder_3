...
export const MISSION_TEMPLATES1: MissionTemplate[] = []

export const MISSION_TEMPLATES: MissionTemplate[] = [
  {
    name: "AIB",
    template: [
      { x: -45, y: 50, z: 0, yaw: 90, pitch: -30, zoomFactor: 1, type: 'security' }, // Left
      { x: -45, y: 50, z: 0, yaw: 90, pitch: -42, zoomFactor: 3, type: 'picture' }, // Left
      { x: 0, y: 0, z: 0, yaw: 0, pitch: -42, zoomFactor: 7, type: 'picture' }, // Origin
      { x: 0, y: 10, z: -10, yaw: 0, pitch: -42, zoomFactor: 7, type: 'picture' },
      { x: 4.5, y: 5.0, z: 0, yaw: 0, pitch: -90, zoomFactor: 1, type: 'security' },
      { x: 45, y: 50, z: 0, yaw: 270, pitch: -42, zoomFactor: 3, type: 'picture' }, // Right
      { x: 45, y: 50, z: 0, yaw: 270, pitch: -30, zoomFactor: 1, type: 'security' }, // Right
    ]
  },
  {
    name: "KIT",
    template: [
      { x: 0, y: 0, z: 0, yaw: 0, pitch: -30, zoomFactor: 1, type: 'security' },
      ...
      { x: 40, y: 40, z: 0, yaw: 270, pitch: -30, zoomFactor: 1, type: 'security' },
    ]
  }
];
